...
local Features_2 = Instance.new("TextLabel")
local KEYBINDS = Instance.new("TextButton")
local SETTINGS = Instance.new("TextButton")
local ImageLabel = Instance.new("ImageLabel")
local Features_3 = Instance.new("TextLabel")
...
Holder.Position = UDim2.new(0.329404056, 0, 0.141277641, 0)
Holder.Size = UDim2.new(0.341191888, 0, 0.716216207, 0)
...
Menu.Size = UDim2.new(1, 0, 0.998284757, 0)

Banner.Name = "Banner"
Banner.Parent = Menu
Banner.BackgroundColor3 = Color3.fromRGB(0, 214, 14)
Banner.BorderSizePixel = 0
Banner.Size = UDim2.new(1, 0, 0.0859106556, 0)

Name.Name = "Name"
Name.Parent = Banner
Name.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
Name.BackgroundTransparency = 1.000
Name.Position = UDim2.new(0.0115163149, 0, 0.119999997, 0)
Name.Size = UDim2.new(0.399232239, 0, 0.75999999, 0)
Name.Font = Enum.Font.Highway
Name.Text = "Project B4SE"
...
Features.BackgroundColor3 = Color3.fromRGB(204, 0, 255)
Features.BackgroundTransparency = 1.000
Features.Position = UDim2.new(0.117082536, 0, 0.115120277, 0)
Features.Size = UDim2.new(0.314779282, 0, 0.0549828187, 0)
Features.Font = Enum.Font.Highway
Features.Text = "ARSENAL"
Features.TextColor3 = Color3.fromRGB(81, 255, 0)
Features.TextScaled = true
Features.TextSize = 14.000
Features.TextWrapped = true

TRIGGERBOT.Name = "TRIGGERBOT"
TRIGGERBOT.Parent = Menu
TRIGGERBOT.BackgroundColor3 = Color3.fromRGB(214, 64, 64)
TRIGGERBOT.BorderSizePixel = 0
TRIGGERBOT.Position = UDim2.new(0.0748560429, 0, 0.341924369, 0)
TRIGGERBOT.Size = UDim2.new(0.399232239, 0, 0.0652920976, 0)
TRIGGERBOT.Font = Enum.Font.Highway
...
AIMLOCK.Parent = Menu
AIMLOCK.BackgroundColor3 = Color3.fromRGB(0, 214, 14)
AIMLOCK.BorderSizePixel = 0
AIMLOCK.Position = UDim2.new(0.0748560429, 0, 0.262886584, 0)
AIMLOCK.Size = UDim2.new(0.399232239, 0, 0.0652920976, 0)
...
ESP.Name = "ESP"
ESP.Parent = Menu
ESP.BackgroundColor3 = Color3.fromRGB(0, 214, 14)
ESP.BorderSizePixel = 0
ESP.Position = UDim2.new(0.0748560429, 0, 0.183848813, 0)
ESP.Size = UDim2.new(0.399232239, 0, 0.0652920976, 0)
...
WALKSPEED.BackgroundColor3 = Color3.fromRGB(0, 214, 14)
WALKSPEED.BorderSizePixel = 0
WALKSPEED.Position = UDim2.new(0.0748560429, 0, 0.422680378, 0)
WALKSPEED.Size = UDim2.new(0.399232239, 0, 0.0652920976, 0)
...
FLY.Name = "FLY"
FLY.Parent = Menu
FLY.BackgroundColor3 = Color3.fromRGB(0, 214, 14)
FLY.BorderSizePixel = 0
FLY.Position = UDim2.new(0.0748560429, 0, 0.5, 0)
FLY.Size = UDim2.new(0.399232239, 0, 0.0652920976, 0)
...
Features_2.Parent = Menu
Features_2.BackgroundColor3 = Color3.fromRGB(204, 0, 255)
Features_2.BackgroundTransparency = 1.000
Features_2.Position = UDim2.new(0.600767732, 0, 0.115120292, 0)
Features_2.Size = UDim2.new(0.314779282, 0, 0.0549828187, 0)
Features_2.Font = Enum.Font.Highway
Features_2.Text = "REGULAR USE"
Features_2.TextColor3 = Color3.fromRGB(81, 255, 0)
Features_2.TextScaled = true
Features_2.TextSize = 14.000
Features_2.TextWrapped = true

KEYBINDS.Name = "KEYBINDS"
KEYBINDS.Parent = Menu
KEYBINDS.BackgroundColor3 = Color3.fromRGB(0, 214, 14)
KEYBINDS.BorderSizePixel = 0
KEYBINDS.Position = UDim2.new(0.558541298, 0, 0.183848813, 0)
KEYBINDS.Size = UDim2.new(0.399232239, 0, 0.0652920976, 0)
KEYBINDS.Font = Enum.Font.Highway
KEYBINDS.Text = "ADMIN"
...
SETTINGS.BackgroundColor3 = Color3.fromRGB(0, 214, 14)
SETTINGS.BorderSizePixel = 0
SETTINGS.Position = UDim2.new(0.558541298, 0, 0.262886584, 0)
SETTINGS.Size = UDim2.new(0.399232239, 0, 0.0652920976, 0)
SETTINGS.Font = Enum.Font.Highway
SETTINGS.Text = "FULL BRIGHT"
...
ImageLabel.Position = UDim2.new(0.424193054, 0, 0.458762884, 0)
ImageLabel.Size = UDim2.new(0.66481179, 0, 0.541237116, 0)
ImageLabel.Image = "http://www.roblox.com/asset/?id=6432642953"
ImageLabel.ScaleType = Enum.ScaleType.Fit

Features_3.Name = "Features"
Features_3.Parent = Menu
Features_3.BackgroundColor3 = Color3.fromRGB(204, 0, 255)
Features_3.BackgroundTransparency = 1.000
Features_3.Position = UDim2.new(0.116765559, 0, 0.587628841, 0)
Features_3.Size = UDim2.new(0.314779282, 0, 0.0549828187, 0)
Features_3.Font = Enum.Font.Highway
Features_3.Text = "REGULAR USE"
Features_3.TextColor3 = Color3.fromRGB(81, 255, 0)
Features_3.TextScaled = true
Features_3.TextSize = 14.000
Features_3.TextWrapped = true

-- Scripts:
--Menu Script
local function KNYZAUM_fake_script() -- Base.LocalScript 
	...
	local UI = script.Parent.Holder.Menu
	local active = false
	
	UserInputService.InputBegan:Connect(function(InputObject, Processed)
		if InputObject.KeyCode == Enum.KeyCode.P and active == true then
			UI:TweenPosition(UDim2.new(-1, 0, 0, 0), 'Out', 'Quad', 0.1, true)
			active = false
		elseif InputObject.KeyCode == Enum.KeyCode.P and active == false then
			UI:TweenPosition(UDim2.new(0, 0, 0, 0), 'Out', 'Quad', 0.1, true)
			active = true
		end
	end)
end
coroutine.wrap(KNYZAUM_fake_script)()

--TriggerBot Script
TRIGGERBOT.MouseButton1Down:connect(function()
	if TriggerActivated == false then
		TriggerActivated = true
		TRIGGERBOT.BackgroundColor3 = Color3.fromRGB(0, 214, 14)

	elseif TriggerActivated == true then
...
UserInputService.InputBegan:Connect(function(InputObject, Processed)
	if InputObject.KeyCode == Enum.KeyCode.E and TriggerActivated == true then
		TRIGGERBOT.BackgroundColor3 = Color3.fromRGB(214, 64, 64)
		TriggerActivated = false
		
	elseif InputObject.KeyCode == Enum.KeyCode.E and TriggerActivated == false then
		TRIGGERBOT.BackgroundColor3 = Color3.fromRGB(0, 214, 14)
		TriggerActivated = true
	end
end)
	...
	game:GetService("RunService").RenderStepped:Connect(function()
		if mouse.Target.Parent:FindFirstChild("Humanoid") and mouse.Target.Parent.Name ~= player.Name  and TriggerActivated == true then
